...
import { getMyProfileHandler, updateProfileHandler,changePasswordHandler,
getLoginHistoryHandler,
getActiveSessionsHandler,getDepositHistoryHandler,getPurchaseHistoryHandler,
getNotificationsHandler,markAllNotificationsAsReadHandler,
